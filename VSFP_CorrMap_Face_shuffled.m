...
%   1) Randomly selects face and imaging data 100 times for shuffled
%   control 
%
% Inputs: 
%        none
...
function VSFP_CorrMap_Face_shuffled(varargin)
    ...
    % Get list of all good trials to pull face data from 
    ...
    % loop through and randomly select imaging and face dataset 100 times 
    for ind = 1:100
        % randomly pick a trial from the list of all good trials load the
        % face trace from this trial 
        ...
        % Correlation With face At Baseline
